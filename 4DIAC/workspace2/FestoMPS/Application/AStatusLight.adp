...
<AdapterType Name="AStatusLight">
  <Identification Standard="61499-1"/>
  <VersionInfo Author="GE" Date="2008-04-22" Organization="4DIAC-Consortium" Version="0.0"/>
  <InterfaceList>
    <EventInputs/>
    <EventOutputs>
      <Event Name="EIred" Type="Event">
        <With Var="BlinkRed"/>
      </Event>
      <Event Name="EIorange" Type="Event">
        <With Var="BlinkOrange"/>
      </Event>
      <Event Name="EIgreen" Type="Event">
        <With Var="BlinkGreen"/>
      </Event>
    </EventOutputs>
    <InputVars/>
    <OutputVars>
      <VarDeclaration Name="BlinkRed" Type="BOOL"/>
      <VarDeclaration Name="BlinkOrange" Type="BOOL"/>
      <VarDeclaration Name="BlinkGreen" Type="BOOL"/>
    </OutputVars>
  </InterfaceList>
