...
<AdapterType Name="APartCount">
  <Identification Standard="61499-1"/>
  <VersionInfo Author="GE" Date="2008-04-22" Organization="4DIAC-Consortium" Version="0.0"/>
  <InterfaceList>
    <EventInputs/>
    <EventOutputs>
      <Event Comment="Indicate part number update" Name="UpdatePartNumber" Type="Event">
        <With Var="PartNumber"/>
      </Event>
    </EventOutputs>
    <InputVars/>
    <OutputVars>
      <VarDeclaration Comment="Actual number of parts on the belt" Name="PartNumber" Type="INT"/>
    </OutputVars>
  </InterfaceList>
